/**
 * API para acessar os web services REST das phrases
 */
(function() {
	angular
		.module('phraseRestService', []);
	
	phraseRestService = function($http, Upload, APP_CONFIG) {
		var urlApi = APP_CONFIG.API_REST + '/phrases';
	...
	angular
		.module('phraseRestService')
		.service('phraseRestService', phraseRestService);
} ());